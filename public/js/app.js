...
// Featured Carousel
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.featured-carousel').slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  arrows: true,
  dots: false,
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter-tab-btn").click(function () {
    ...
    setTimeout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.team-slider').slick('setPosition');
    }, 200);
    if (value == "all") {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter').show('700');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter').parents('.slick-slide').show('700');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter").not('.' + value).hide('2000');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter').not('.' + value).parents('.slick-slide').hide('2000');
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter').filter('.' + value).parents('.slick-slide').show('2000');
    }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  var delay = false;
  var currentPage = 1;
  var pageCount = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".scrollbar-section .section-padding").length;
